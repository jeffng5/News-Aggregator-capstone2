...
if (state) {
    return (
        <button className='archived'><img src = {myImage} alt=''></img>Archived</button>
    )
}
if (!state){
return (
    <>
    <button className='archive' onClick={handleArchive}><img src = {myImage} alt=''></img>Archive</button>
